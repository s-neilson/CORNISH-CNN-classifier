...
* downloadFileSuffix: Suffixes of file URLs following the name. There can be many of these suffixes in the download configuration file; each entry of downloadFileSuffix needs to be on a seperate line.
